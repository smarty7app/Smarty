  ...
  return (
    <div className="flex flex-col h-full min-h-screen bg-[#E65100] dark:bg-zinc-950 text-black dark:text-white transition-colors duration-500">
      ...
      <div className="flex-1 flex flex-col items-center p-6 pt-16">
        ...
        <div className="bg-white dark:bg-zinc-900 rounded-[2.5rem] p-6 w-full max-w-md shadow-xl border border-black/5 dark:border-white/5 mb-8 text-center">
  <div className="w-16 h-16 bg-[#E65100] rounded-2xl flex items-center justify-center mx-auto mb-3">
