...
export default function LoginPage() {
  ...
  // ✅ الدخول كضيف (تجاوز المصادقة مؤقتاً) باستخدام كوكي
  const handleGuestMode = () => {
    // تعيين كوكي guest_mode صالح لمدة يوم واحد (مسار الجذر)
    document.cookie = "guest_mode=true; path=/; max-age=86400";
    // التوجيه إلى الصفحة الرئيسية
    router.push("/");
  };

  // ✅ تحديد ما إذا كان سيتم عرض زر الضيف (فقط في بيئة التطوير أو عند تفعيل متغير بيئة)
