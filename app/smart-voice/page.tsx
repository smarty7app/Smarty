...
export default function SmartVoicePage() {
  ...
  return (
    <div className="min-h-screen bg-[#E65100] dark:bg-black flex flex-col transition-colors duration-300">
      ...
      {/* ========== حوار اختيار وتحميل النماذج (جديد) ========== */}
      {showModelDialog && (
