...
export async function POST(request: NextRequest) {
  try {
    ...
    if (looksLikeReminder) {
      ...
      // ✅ خطة بديلة: استخدام التحليل المحلي إذا فشل Groq
      ...
      // إذا فشل كلاهما، نستمر إلى الدردشة العادية
    }

    // ✅ الدردشة العادية (مع الذاكرة)
    ...
    // ✅ الرد العادي بصيغة JSON لتتوافق مع واجهة smart-voice
