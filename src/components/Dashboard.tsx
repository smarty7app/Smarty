      ...
      >
        ...
        <div className="flex items-center justify-between glass-panel rounded-2xl p-4">
          <button
            ...
            className="p-2.5 bg-slate-100 dark:bg-zinc-900 border border-slate-300 dark:border-zinc-850 hover:bg-slate-200 dark:hover:bg-zinc-800 text-slate-700 dark:text-zinc-300 rounded-xl transition-all flex items-center justify-center cursor-pointer active:scale-95 shadow-md"
          >
        ...
        <div className="relative">
          ...
          {filterSearch && (
            <button
              ...
              className="absolute inset-y-0 left-0 pl-3 flex items-center text-slate-500 hover:text-slate-800 dark:text-zinc-400 dark:hover:text-white text-xs cursor-pointer"
            >
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-3 mb-6 border-b border-zinc-805 pb-4">
          ...
          {suspiciousCount > 0 && (
            <button 
              ...
              className="bg-amber-500/10 dark:bg-yellow-500/10 hover:bg-amber-500/15 dark:hover:bg-yellow-500/20 border border-amber-500/20 dark:border-yellow-500/30 rounded-xl px-3 py-1.5 flex items-center gap-2 self-start md:self-auto select-none transition-all cursor-pointer active:scale-95"
            >
              <AlertTriangle className="w-4 h-4 text-amber-600 dark:text-yellow-500 shrink-0" />
              <span className="text-[10px] font-extrabold text-amber-700 dark:text-yellow-400 font-sans tracking-wide">
                ...
                <div className="relative md:col-span-2">
                  ...
                  {labelsSearch && (
                    <button 
                      ...
                      className="absolute inset-y-0 left-0 pl-3 flex items-center text-slate-500 hover:text-slate-800 dark:text-zinc-500 dark:hover:text-white text-xs cursor-pointer"
                    >
                      {isAr ? "مسح" : "Effacer"}
                    </button>
                  )}
                          ...
                          <tr key={o.id} className="hover:bg-zinc-900/15 transition-colors">
                            <td className="p-4">
                              ...
                              {o.items && o.items.length > 0 && (
                                <div className="mt-1.5 flex flex-wrap gap-1.5 justify-start text-right">
                                  {o.items.map((item: any, idx: number) => (
                                    <span key={idx} className="inline-flex items-center gap-1 text-[9px] bg-zinc-900/80 text-zinc-350 border border-zinc-800 px-1.5 py-0.5 rounded font-mono font-medium">
                                      <span className="text-purple-400 font-extrabold">{item.quantity}x</span>
                                      <span className="truncate max-w-[120px] font-sans font-bold">{item.product}</span>
                                    </span>
                                  ))}
                                </div>
                              )}
                            ...
                            <td className="p-4">
                              <div className="flex items-center justify-center gap-2">
                                <button 
                                  ...
                                  className="p-2.5 hover:bg-slate-150 dark:hover:bg-zinc-800 rounded-xl text-amber-600 dark:text-yellow-500 transition-colors cursor-pointer"
                                ...
                                {o.label_url && (
                                  <a 
                                    ...
                                    target="_blank"
                                    rel="noreferrer"
                                    className="p-2.5 hover:bg-slate-150 dark:hover:bg-zinc-800 rounded-xl text-emerald-600 dark:text-emerald-400 transition-colors cursor-pointer flex items-center justify-center"
                      ...
                      <div key={o.id} className="bg-zinc-950/40 border border-zinc-850 p-4 rounded-2xl flex flex-col justify-between space-y-3.5">
                            ...
                            <div>
                              ...
                              {o.items && o.items.length > 0 && (
                                <div className="mt-1.5 flex flex-wrap gap-1">
                                  {o.items.map((item: any, idx: number) => (
                                    <span key={idx} className="inline-flex items-center gap-1 text-[9px] bg-zinc-900/60 text-zinc-300 border border-zinc-800/80 px-1.5 py-0.5 rounded font-mono">
                                      <span className="text-purple-400 font-extrabold">{item.quantity}x</span>
                                      <span className="truncate max-w-[100px] font-sans font-bold">{item.product}</span>
                                    </span>
                                  ))}
                                </div>
                              )}
                        ...
                        <div className="flex gap-2.5 border-t border-zinc-900/60 pt-2.5">
                          <button 
                            ...
                            className="flex-1 py-2 bg-slate-100 hover:bg-slate-200 dark:bg-zinc-900 dark:hover:bg-zinc-800 border border-slate-200 dark:border-zinc-800 text-slate-700 dark:text-zinc-200 rounded-xl text-[10px] font-bold flex items-center justify-center gap-1 cursor-pointer select-none"
                          >
                            <Eye className="w-3.5 h-3.5 text-amber-600 dark:text-yellow-500" />
                            {isAr ? "معاينة" : "Preview"}
                          </button>
                          {o.label_url && (
                            <a 
                              ...
                              target="_blank"
                              rel="noreferrer"
                              className="flex-1 py-2 bg-emerald-500/10 hover:bg-emerald-500/15 border border-emerald-500/20 text-emerald-700 dark:text-emerald-400 rounded-xl text-[10px] font-bold flex items-center justify-center gap-1 cursor-pointer text-center select-none"
                            >
        ...
        <div className="space-y-4">
          ...
          <div className="flex justify-center pb-2">
            <button 
              ...
              className="w-full max-w-md py-4 px-6 bg-gradient-to-r from-purple-600 via-violet-600 to-indigo-600 hover:from-purple-500 hover:to-indigo-500 text-white font-extrabold rounded-2xl flex items-center justify-center gap-2 shadow-lg shadow-purple-500/10 dark:shadow-purple-500/5 transition-all duration-200 active:scale-[0.98] font-sans cursor-pointer border border-purple-500/20"
            >
           ...
           <div className="flex flex-col gap-4">
                ...
                <div className="flex-1 max-w-sm relative">
                  ...
                  {ordersSearch && (
                    <button
                      ...
                      className="absolute inset-y-0 left-0 pl-3 flex items-center text-slate-500 hover:text-slate-800 dark:text-zinc-500 dark:hover:text-white transition-colors cursor-pointer"
                    >
                      <X className="w-3 h-3" />
                    </button>
                  )}
                ...
                {ordersHistory.length > 0 && (
                  <div className="flex items-center gap-2">
                   <button
                     ...
                     className="text-[10px] text-amber-700 hover:text-amber-900 dark:text-yellow-500/80 dark:hover:text-yellow-500 hover:underline transition-all font-black cursor-pointer"
                   >
             ...
             <AnimatePresence>
               {selectedOrderIds.length > 0 && (
                 ...
                 >
                   <div className="bg-amber-500/10 dark:bg-yellow-500/10 border border-amber-500/20 dark:border-yellow-500/20 p-4 rounded-2xl flex flex-col md:flex-row items-center justify-between gap-3 font-sans shadow-lg shadow-yellow-950/5 text-right md:text-right">
                     <div className="text-right w-full md:w-auto">
                       <h4 className="text-xs font-black text-amber-700 dark:text-yellow-500 uppercase tracking-wide flex items-center gap-1.5 justify-start">
                         <span className="w-2 h-2 rounded-full bg-amber-600 dark:bg-yellow-500"></span>
                         العمليات الجماعية للطلبيات
                       </h4>
                       <p className="text-[11px] text-zinc-400 mt-0.5">
                         تم اختيار <span className="text-amber-700 dark:text-yellow-400 font-extrabold font-mono">{selectedOrderIds.length}</span> طلبية معلقة للفرز والربط التلقائي وإرسالها لشركة الشحن.
                       </p>
                     </div>
                     <div className="flex gap-2 w-full md:w-auto flex-wrap md:flex-nowrap items-center">
                       ...
                       <button
                         ...
                         className="flex-1 md:flex-none py-2.5 px-4.5 bg-amber-600 hover:bg-amber-700 text-white dark:bg-yellow-500 dark:hover:bg-yellow-600 dark:text-black font-extrabold text-[11px] rounded-xl flex items-center justify-center gap-1.5 transition-all cursor-pointer active:scale-95 disabled:opacity-50"
                       >
                         {bulkConfirming ? (
                           <>
                       ...
                       <button
                         type="button"
                         onClick={() => setSelectedOrderIds([])}
                         className="py-2.5 px-3 bg-slate-100 hover:bg-slate-200 dark:bg-zinc-800 dark:hover:bg-zinc-750 text-slate-700 dark:text-zinc-350 border border-slate-300 dark:border-zinc-700 font-bold text-xs rounded-xl transition-all cursor-pointer"
                       >
                         إلغاء
                       </button>
                     </div>
                     ...
                     <div className="flex items-center gap-3">
                       ...
                       <div>
                         ...
                         {order.items && order.items.length > 0 && (
                           <div className="mt-2.5 flex flex-col gap-1 border-t border-zinc-900/60 pt-2 text-right">
                             {order.items.map((item: any, idx: number) => (
                               <div key={idx} className="flex items-center gap-2 text-xs text-zinc-300">
                                 <span className="px-1.5 py-0.5 rounded bg-zinc-900 text-purple-400 font-extrabold font-mono text-[10px] border border-zinc-850">
                                   {item.quantity}x
                                 </span>
                                 <span className="font-bold text-zinc-200 truncate max-w-[150px]" title={item.product}>
                                   {item.product || (isAr ? "منتج غير محدد" : "Unspecified Product")}
                                 </span>
                                 {(item.size || item.color) && (
                                   <span className="text-[9px] text-zinc-500 bg-zinc-900/80 px-1.5 py-0.2 rounded font-mono border border-zinc-900">
