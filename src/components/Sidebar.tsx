            ...
            <div className="flex-1 space-y-1.5">
              <button 
                ...
                className={`w-full flex items-center gap-3 p-3 rounded-2xl transition-all cursor-pointer border ${
                  screen === 'dashboard' 
                    ? 'bg-purple-500/10 dark:bg-purple-600/15 border-purple-500/20 dark:border-purple-550/30 text-purple-700 dark:text-white font-extrabold shadow-sm' 
                    : 'border-transparent text-slate-500 dark:text-zinc-400 hover:bg-slate-50 dark:hover:bg-white/[0.02] hover:text-slate-800 dark:hover:text-zinc-200'
                }`}
              >
