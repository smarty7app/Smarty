...
│
├── 📁 src/                            # Front-end source code and UI logic
...
│   │   ├── WilayasList.tsx            # Geographical guide for Algeria's 58 Wilayas with shipping calculator
...
1. Create a new project in your Firebase Console.
...
1. Configure Meta Developer Dashboard:
   · Navigate to developers.facebook.com and create a Business App type.
